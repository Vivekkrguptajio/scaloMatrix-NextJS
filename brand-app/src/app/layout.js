...
export const metadata = {
  title: "Brand Strategy | Scalomatrix",
  description: "Professional brand strategy and identity design.",
  keywords: "brand strategy, brand identity, logo design, brand positioning, creative agency",
