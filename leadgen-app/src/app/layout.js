...
export const metadata = {
  title: "Lead Generation | Scalomatrix",
  description: "High-quality lead generation and B2B solutions.",
  keywords: "lead generation, B2B leads, sales pipeline, inbound marketing, outbound outreach",
