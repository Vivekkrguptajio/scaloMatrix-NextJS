...
export const metadata = {
  title: "Finance Solutions | Scalomatrix",
  description: "Strategic finance solutions for digital growth.",
  keywords: "finance solutions, financial growth, accounting services, business finance, digital finance",
